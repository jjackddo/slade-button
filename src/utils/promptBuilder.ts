...
const EXECUTION_COMMANDS: Record<string, string> = {
    ...
    prototype: '전역 지침과 버튼 지침에 따라 아래 컨텍스트를 기반으로 게임 프로토타입 설계안을 도출해 주세요. 반드시 Canvas 도구를 활성화해서 코드로 작성해줘',
    chat: '위의 지침과 컨텍스트를 바탕으로 자유롭게 의견을 나누어 주세요. 반드시 도구(Tool)로서 Canvas를 활용해 주세요.'
}
